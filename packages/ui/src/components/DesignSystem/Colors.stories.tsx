...
export const Semantic = () => (
  <>
    <Section title="セマンティックカラー（Semantic）">
      ...
      <h3 style={{ marginBottom: '16px', fontSize: '18px', fontWeight: '600', marginTop: '32px' }}>
        Warning（警告・注意）
      </h3>
      <ColorGrid>
      ...
      <h3 style={{ marginBottom: '16px', fontSize: '18px', fontWeight: '600', marginTop: '32px' }}>Info（情報）</h3>
      <ColorGrid>
